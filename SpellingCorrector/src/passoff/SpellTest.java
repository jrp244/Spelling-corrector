...
public class SpellTest {
    ...
    private static final String WORD_FILENAME = "spelltestfiles/word.txt";
    private static final String WORDS_FILENAME = "spelltestfiles/words.txt";
    private static final String BIG_FILENAME = "spelltestfiles/notsobig.txt";
